        ...
        const menuIT = {
            ...
            rejoindre: [
                ...
                { id: 'pagePartenariat', title: 'Partenariat', desc: 'Coopération' }
            ],
            contact: [
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function buildFullscreenMenu() {
                ...
                // SWITCHER EN HAUT (priorité)
                const switchText = site === 'it' ? 'Hub Stratégique' : 'Lab Technique';
                html += `<div class="menu-action menu-action-primary" data-action="switch">${switchText}</div>`;
        ...
        function switchSite() {
            ...
            // Track site switch in Google Analytics
            if (typeof trackSiteSwitch === 'function') {
                trackSiteSwitch(previousSite, currentSite);
            }
        ...
        function goHome() {
            ...
            // 1. CACHER IMMÉDIATEMENT les landing pages (pas d'attente)
            document.querySelectorAll('.work-in-progress, .main-container').forEach(p => p.classList.remove('active'));
            ...
            // 3. Afficher la welcome page pendant l'animation (plus fluide)
            setTimeout(() => {
        ...
        function showPage(pageId) {
            ...
            if (page) {
                ...
                // Track expertise/page click in Google Analytics
                if (typeof trackExpertiseClick === 'function') {
                    trackExpertiseClick(pageId, currentSite);
                }
            }
        ...
        function showExperts() {
            ...
            // DUPLIQUER le contenu pour scroll infini fluide
            ...
            // DUPLICATION pour scroll continu
            experts.forEach(expert => {
                html += `<div class="expert-item-island"><span class="expert-name-island">${expert.name}</span> ${expert.role}</div>`;
            });
            html += '</div>';
...
<div class="story-section">
                        ...
                        <div class="cta-section">
                            ...
                            <button class="cta-button" onclick="openContactModal()">Poser ma question <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width: 18px; height: 18px; display: inline-block; vertical-align: middle; margin-left: 6px;"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="work-in-progress" id="pageWorkshops">
                    <div class="story-container">
                        ...
                        <div class="cta-section">
                            ...
                            <button class="cta-button" onclick="openContactModal()">Nous contacter <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width: 18px; height: 18px; display: inline-block; vertical-align: middle; margin-left: 6px;"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg></button>
                        </div>
                    </div>
                </div>
...
<div class="story-section">
                            <div class="story-card">
                                ...
                                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 20px; margin-top: 30px;">
                                    <div style="padding: 25px; background: rgba(255, 127, 92, 0.05); border: 1px solid rgba(255, 127, 92, 0.2); border-radius: 12px;">
                                        ...
                                        <div class="story-text" style="font-size: 0.95rem; line-height: 1.7; margin: 0;">Développeurs fullstack, architectes cloud, DevOps, data engineers, experts cybersécurité</div>
                                    </div>
                                    <div style="padding: 25px; background: rgba(255, 127, 92, 0.05); border: 1px solid rgba(255, 127, 92, 0.2); border-radius: 12px;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: #FF7F5C; margin-bottom: 12px;">Product & Stratégie</div>
                                        <div class="story-text" style="font-size: 0.95rem; line-height: 1.7; margin: 0;">Product owners, product managers, consultants en transformation digitale</div>
                                    </div>
                                    <div style="padding: 25px; background: rgba(255, 127, 92, 0.05); border: 1px solid rgba(255, 127, 92, 0.2); border-radius: 12px;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: #FF7F5C; margin-bottom: 12px;">Gouvernance & Pilotage</div>
                                        <div class="story-text" style="font-size: 0.95rem; line-height: 1.7; margin: 0;">Directeurs de projet, PMO, RSSI, consultants en gouvernance IT</div>
                                    </div>
                                    <div style="padding: 25px; background: rgba(255, 127, 92, 0.05); border: 1px solid rgba(255, 127, 92, 0.2); border-radius: 12px;">
                                        <div style="font-size: 1.2rem; font-weight: 700; color: #FF7F5C; margin-bottom: 12px;">HR & Business</div>
                                        <div class="story-text" style="font-size: 0.95rem; line-height: 1.7; margin: 0;">Chargé(e) de recrutement, responsable RH, business développeur, directeur d'agence</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="cta-section">
                            ...
                            <button class="cta-button" onclick="openChatModal('Je souhaite rejoindre Liwe', 'recruitment')">Postuler <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width: 18px; height: 18px; display: inline-block; vertical-align: middle; margin-left: 6px;"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg></button>
                        </div>
                    </div>
                </div>
                ...
                <div class="work-in-progress" id="pagePartenariat">
                    <div class="story-container">
                        ...
                        <div class="cta-section">
                            ...
                            <button class="cta-button" onclick="openChatModal()">Contactez notre agent IA <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="width: 18px; height: 18px; display: inline-block; vertical-align: middle; margin-left: 6px;"><path d="M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"/></svg></button>
                        </div>
                    </div>
                </div>
